...
import { Zap, Shield, Users, CheckCircle, Award, Clock, TrendingUp, Lightbulb, HeadphonesIcon, Globe, Target, Rocket, ArrowRight } from "lucide-react";
const WhyChooseUs = () => {
  const advantages = [{
    icon: Users,
      ...
      <section className="pt-32 pb-20 gradient-hero">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-display font-bold mb-6">WHY JUDITH TECH?</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {advantages.map((advantage, index) => <Card key={index} className="border-2 hover:shadow-medium transition-smooth group">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              {differentiators.map((item, index) => <Card key={index} className="border-2">
